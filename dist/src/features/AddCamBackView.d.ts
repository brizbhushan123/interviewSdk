 ...
 *
 */
declare class AddCamBackView extends StepInterface {
    envAlias: string;
    camType: string;
    ...
    streamBackInterval: ReturnType<typeof setInterval> | null;
    ntwDisconnectBack: boolean;
    /**
     *
     */
    constructor();
...
export declare const addCamBackView: AddCamBackView;
export {};
